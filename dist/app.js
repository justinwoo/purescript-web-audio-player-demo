      ...
      var $$eval = function (v) {
          if (v instanceof FileSet) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                                      ...
                                      $21.file = Data_Maybe.Just.create(Data_Newtype.wrap(newtypeFilePath)(v2));
                                      return $21;
                                  });
                              });
                          });
              ...
              var handleInput = function (el) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_HTML_HTMLInputElement.files(el)))(function (v1) {
                      var $25 = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Nullable.toMaybe(v1))(function ($42) {
                      ...
                      if ($25 instanceof Data_Maybe.Just) {
                          return handleFile($25.value0);
                      };
                      throw new Error("Failed pattern match at Main line 109, column 11 - line 111, column 41: " + [ $25.constructor.name ]);
                  });
              };
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(Data_Newtype.wrap(Halogen_Query_InputF.newtypeRefLabel)("input")))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var $28 = Control_Bind.bind(Data_Maybe.bindMaybe)(v1)(DOM_Classy_HTMLElement.fromHTMLElement(DOM_Classy_HTMLElement.isHTMLElementHTMLInputElement));
                      ...
                      if ($28 instanceof Data_Maybe.Just) {
                          return handleInput($28.value0);
                      };
                      throw new Error("Failed pattern match at Main line 102, column 7 - line 104, column 34: " + [ $28.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof Skip) {
              var skip = (function () {
                  ...
                  throw new Error("Failed pattern match at Main line 133, column 16 - line 137, column 9: " + [ v.value1.constructor.name ]);
              })();
          ...
          throw new Error("Failed pattern match at Main line 100, column 5 - line 121, column 44: " + [ v.constructor.name ]);
      };
