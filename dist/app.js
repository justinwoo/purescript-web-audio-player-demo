      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Skip) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(Data_Newtype.wrap(Halogen_Query_InputF.newtypeRefLabel)("audio")))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var v2 = Data_Functor.map(Data_Maybe.functorMaybe)(DOM_HTML_Types.htmlAudioElementToHTMLMediaElement)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(DOM_Classy_HTMLElement.fromHTMLElement(DOM_Classy_HTMLElement.isHTMLElementHTMLAudioElement))(v1));
                      if (v2 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_HTML_HTMLMediaElement.currentTime(v2.value0)))(function (v3) {
                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_HTML_HTMLMediaElement.setCurrentTime(v3 + delta)(v2.value0));
                          });
                      };
                      return log$prime("No audio ref found");
                  })())(function () {
