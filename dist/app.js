...
(function(exports) {
  ...
  var monadStateHalogenM = new Control_Monad_State_Class.MonadState(function () {
      ...
      return HalogenM(Control_Monad_Free.liftF(ModifyState.create($71)));
  });
              ...
              return function (prjQuery) {
                  return function (lchs) {
                      return function __do() {
                          ...
                          var v5 = Control_Monad_Eff_Ref.newRef(0)();
                          var v6 = Control_Monad_Eff_Ref.newRef(new Data_Maybe.Just(Data_Map.empty))();
                          var ds = {
                              component: component, 
      ...
      return function (ref) {
          return function (message) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(ref)))(function (v) {
                  ...
                  throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 197, column 3 - line 201, column 57: " + [ v.constructor.name ]);
              });
          };
      };
  };
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.newRef(v.value1)))(function (v2) {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(a))(function (v3) {
                          ...
                          if (v3 instanceof Data_Either.Right) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v2)))(function (v4) {
                                  ...
                                  throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 53, column 15 - line 55, column 57: " + [ v4.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 49, column 23 - line 55, column 57: " + [ v3.constructor.name ]);
                      });
                  };
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.forkAll(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(run)(v)))(function (v3) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar.peekVar(v1))(function (v4) {
                          ...
                          throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 57, column 24 - line 59, column 33: " + [ v4.constructor.name ]);
                      });
                  });
              });
          });
      };
      throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 41, column 19 - line 59, column 33: " + [ v.constructor.name ]);
  };
  ...
  var $$eval = function (render) {
      return function (r) {
          var go = function (ref) {
              return function (v) {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(ref)))(function (v1) {
                          ...
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.writeRef(ref)((function () {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(handleLifecycle(v1.lifecycleHandlers)(render(v1.lifecycleHandlers)(ref)))(function () {
                                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)($61.value0);
                              });
                          });
                      });
                  };
                  ...
                  if (v instanceof Halogen_Query_HalogenM.Par) {
                      return Control_Parallel_Class.sequential(Control_Monad_Aff.parallelParAff)(Control_Applicative_Free.retractFreeAp(Control_Monad_Aff.applicativeParAff)(Control_Applicative_Free.hoistFreeAp(function ($129) {
                          return Control_Parallel_Class.parallel(Control_Monad_Aff.parallelParAff)(evalM(ref)($129));
                      })(v.value0)));
                  };
                  if (v instanceof Halogen_Query_HalogenM.Fork) {
                      return Halogen_Query_ForkF.unFork(function (v1) {
                          return Data_Functor.map(Control_Monad_Aff.functorAff)(function ($130) {
                              return v1.value1(Data_Functor.map(Data_Functor.functorFn)(Control_Monad_Aff_Unsafe.unsafeCoerceAff)($130));
                  ...
                  throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 101, column 12 - line 154, column 34: " + [ v.constructor.name ]);
              };
          };
          ...
          var evalF = function (ref) {
              return function (q) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(ref)))(function (v) {
                      var $113 = v["component"]["eval"](q);
                      return Control_Monad_Free.foldFree(Control_Monad_Aff.monadRecAff)(go(ref))($113);
                  });
              };
          };
          var evalChildQuery = function (ref) {
              return function (p) {
                  return Data_Coyoneda.unCoyoneda(function (k) {
                      return function (q) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(ref)))(function (v) {
                              var $115 = Data_Map.lookup(Halogen_Data_OrdBox.ordOrdBox)(v.component.mkOrdBox(p))(v.children);
                              if ($115 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef($115.value0)))(function (v1) {
                                      return Halogen_Aff_Driver_State.unDriverStateX(function (ds) {
                                          var $117 = ds.prjQuery(q);
                                          if ($117 instanceof Data_Maybe.Just) {
                                              return Data_Functor.map(Control_Monad_Aff.functorAff)(k)(evalF(ds.selfRef)($117.value0));
                                          };
                                          ...
                                          throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 167, column 32 - line 169, column 82: " + [ $117.constructor.name ]);
                                      })(v1);
                                  });
                              };
                              ...
                              throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 164, column 5 - line 170, column 73: " + [ $115.constructor.name ]);
                          });
                      };
                  });
              };
          ...
          return function (v) {
              if (v instanceof Halogen_Query_InputF.RefUpdate) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.modifyRef(r)(function (v1) {
                      ...
                      $122.refs = Data_StrMap.alter(Data_Function["const"](v.value1))(v.value0)(v1.refs);
                      return $122;
                  })))(function () {
              ...
              throw new Error("Failed pattern match at Halogen.Aff.Driver.Eval line 87, column 3 - line 92, column 25: " + [ v.constructor.name ]);
          };
      };
  };
  exports["eval"] = $$eval;
          ...
          return function (i) {
              ...
              var handlePending = function (ref) {
                  return function __do() {
                      ...
                      return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(v)(function ($50) {
                          return handleAff(Control_Monad_Aff.forkAll(Data_List_Types.foldableList)(Data_List.reverse($50)));
                      })();
                  };
              };
              var cleanupSubscriptions = Halogen_Aff_Driver_State.unDriverStateX(function (ds) {
                  return function __do() {
                      Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(function ($51) {
                          return handleAff(Control_Monad_Aff.forkAll(Data_Map.foldableMap)($51));
              ...
              var squashChildInitializers = function (lchs) {
                  return function (preInits) {
                      return Halogen_Aff_Driver_State.unDriverStateX(function (st) {
                          var parentInitializer = Data_Functor.map(Data_Maybe.functorMaybe)(function ($52) {
                              return evalF(st.selfRef)(Halogen_Query_InputF.Query.create($52));
                          ...
                          return function (prjQuery) {
                              return Halogen_Component.unComponent(function (c) {
                                  return function __do() {
                                      ...
                                      Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(Halogen_Aff_Driver_State.unDriverStateX(function ($53) {
                                                  ...
                                                  return function (outputQuery) {
                                                      return function (prjQuery) {
                                                          return function __do() {
                                                              ...
                                                              var v1 = (function () {
                                                                  var $31 = Data_Map.pop(Halogen_Data_OrdBox.ordOrdBox)(mkOrdBox(p))(v);
                                                                  if ($31 instanceof Data_Maybe.Just) {
                                                                      return function __do() {
                                                                          Control_Monad_Eff_Ref.writeRef(childrenInRef)($31.value0.value1)();
                                                                          Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(inputQuery(input))(function (q) {
                                                                              return function __do() {
                                                                                  var v1 = Control_Monad_Eff_Ref.readRef($31.value0.value0)();
                                                                                  return Halogen_Aff_Driver_State.unDriverStateX(function (st) {
                                                                                      return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(st.prjQuery(q))(function ($54) {
                                                                                          return handleAff(evalF(st.selfRef)(Halogen_Query_InputF.Query.create($54)));
                                                                                      });
                                                                                  })(v1)();
                                                                              };
                                                                          })();
                                                                          return $31.value0.value0;
                                                                      };
                                                                  };
                                                                  if ($31 instanceof Data_Maybe.Nothing) {
                                                                      return runComponent(lchs)(function ($55) {
                                                                          return Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(handler)(outputQuery($55));
                                                                      })(input)(prjQuery)(ctor);
                                                                  };
                                                                  throw new Error("Failed pattern match at Halogen.Aff.Driver line 187, column 14 - line 195, column 92: " + [ $31.constructor.name ]);
                                                              })()();
                                                              ...
                                                              return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_Ref.readRef(v1))(Halogen_Aff_Driver_State.renderStateX(Control_Monad_Eff.functorEff)(function (v2) {
                                                                  ...
                                                                  throw new Error("Failed pattern match at Halogen.Aff.Driver line 197, column 36 - line 199, column 50: " + [ v2.constructor.name ]);
                                                              }))();
                                                          };
                                                      };
                                                  };
              ...
              var render = function (lchs) {
                  return function ($$var) {
                      return function __do() {
                          ...
                          var handler = function ($56) {
                              return Data_Functor["void"](Control_Monad_Aff.functorAff)(evalF(v.selfRef)($56));
                          };
                          var childHandler = Halogen_Aff_Driver_Eval.queuingHandler(function ($57) {
                              return handler(Halogen_Query_InputF.Query.create($57));
                          })(v.pendingQueries);
                          var v1 = renderSpec.render(function ($58) {
                              return handleAff(handler($58));
                          ...
                          Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_Ref.readRef(v.childrenIn))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Map.foldableMap)(function (childVar) {
                              return function __do() {
                                  ...
                                  cleanupSubscriptions(v3)();
                                  return addFinalizer(lchs)(v3)();
                              };
                          }))();
                          return Control_Monad_Eff_Ref.modifyRef($$var)(function (v3) {
                              return {
                                  ...
                                  lifecycleHandlers: v3.lifecycleHandlers
                              };
                          })();
                      };
                  };
              ...
              var addFinalizer = function (lchs) {
                  return Halogen_Aff_Driver_State.unDriverStateX(function (st) {
                      return function __do() {
                          Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(function ($59) {
                              return evalF(st.selfRef)(Halogen_Query_InputF.Query.create($59));
                  ...
                  return function (prjQuery) {
                      return function (q) {
                          ...
                          if ($44 instanceof Data_Maybe.Just) {
                              return evalF(ref)(new Halogen_Query_InputF.Query($44.value0));
                          };
                          ...
                          throw new Error("Failed pattern match at Halogen.Aff.Driver line 77, column 5 - line 79, column 110: " + [ $44.constructor.name ]);
                      };
                  };
              };
              ...
              return function (child) {
                  return function (v) {
                      return function (v1) {
                          ...
                          throw new Error("Failed pattern match at Halogen.VDom.Driver line 117, column 5 - line 133, column 80: " + [ v1.constructor.name ]);
                      };
                  };
              };
          };
